package com.github.kyazuki.growthmod.network;

import com.github.kyazuki.growthmod.capabilities.ScaleProvider;
import com.github.kyazuki.growthmod.events.GrowthModEvents;
    ...
    public static DistExecutor.SafeRunnable handleClient(int playerEntityID, float scale) {
      return new DistExecutor.SafeRunnable() {
        ...
        public void run() {
          ...
          MinecraftForge.EVENT_BUS.post(new GrowthModEvents.UpdatePlayerSizeEvent((PlayerEntity) player));
        }
      };
    }
  }
